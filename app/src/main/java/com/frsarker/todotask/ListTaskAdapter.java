...
public class ListTaskAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.task_content = convertView.findViewById(R.id.task_content);
        ...
        holder.task_content.setId(position);
        ...
        try {
            ...
            if (singleTask.get("status").contentEquals("1")) {
                holder.task_name.setText(Html.fromHtml("<strike>" + singleTask.get("title") + "</strike>"));
                holder.task_content.setText(Html.fromHtml("<strike>" + singleTask.get("content") + "</strike>"));
                holder.task_date.setText(Html.fromHtml("<strike>" + singleTask.get("task_at") + "</strike>"));
                holder.checkBtn.setChecked(true);
            } else {
                holder.task_name.setText(singleTask.get("title"));
                holder.task_content.setText(singleTask.get("content"));
                holder.task_date.setText(singleTask.get("task_at"));
            ...
            holder.checkBtn.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                        ...
                        tmpHolder.task_content.setText(Html.fromHtml("<strike>" + singleTask.get("content") + "</strike>"));
                        tmpHolder.task_name.setText(Html.fromHtml("<strike>" + singleTask.get("title") + "</strike>"));
                        tmpHolder.task_date.setText(Html.fromHtml("<strike>" + singleTask.get("task_at") + "</strike>"));
                    } else {
                        database.updateTaskStatus(singleTask.get("id"), 0);
                        tmpHolder.task_content.setText(singleTask.get("content"));
                        tmpHolder.task_name.setText(singleTask.get("title"));
                        tmpHolder.task_date.setText(singleTask.get("task_at"));
                    }
                }
            });
